...
# pandas_df= pandas_df[(pandas_df.country == 'Greece')]
...
X_train, X_test, y_train, y_test = train_test_split(pandas_df_categorization["clean_text"],pandas_df_categorization["Information"],test_size=0.3,shuffle=True)
...
path_to_information_classification_model = str(dir_path.absolute()) + "/classification_models/DC_Service_Information_classification_model.joblib"
information_classification_model = load(path_to_information_classification_model)

# Predict y value for test dataset
y_predict = information_classification_model.predict(X_test_vectors_w2v)
y_prob = information_classification_model.predict_proba(X_test_vectors_w2v)[:, 1]
...
# print('AUC:', roc_auc)
#
# dump(clf, 'Classification_models/DC_Service_Information_classification_model.joblib')